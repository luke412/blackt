//
//  About2_ViewController.m
//  BlackT2017
//
//  Created by 鲁柯 on 2017/2/10.
//  Copyright © 2017年 鲁柯. All rights reserved.
//  https://h5.koudaitong.com/v2/showcase/mpnews?spm=m1486694257440898482680869.click&alias=YZJnmb6RxK
// 公司介绍界面
#import "About2_ViewController.h"

@interface About2_ViewController ()<UIWebViewDelegate>
{
    UIWebView *webView;
    NSTimer *timer;
...
@implementation About2_ViewController
...
- (void)viewDidLoad {
    ...
    NSURL* url = [NSURL URLWithString:@"https://h5.koudaitong.com/v2/showcase/mpnews?spm=m1486694257440898482680869.click&alias=YZJnmb6RxK"];//创建URL
...
-(void)createProgressBar{
    progressView=[[UIProgressView alloc]initWithFrame:CGRectMake(0, 64, WIDTH_lk, 1)];
    progressView.tintColor=[LKTool from_16To_Color:@"3399ff"];
