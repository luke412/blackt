...
@interface SheZhi_ViewController ()<UITableViewDataSource,UITableViewDelegate>
{
    UITableView *tableView_LK;
    NSArray     *titleArr;
    SheZhi_Handler *sheZhiHandler;
}
@end
...
- (void)viewDidLoad {
    [super viewDidLoad];
    sheZhiHandler = [[SheZhi_Handler alloc]init];
    [self setTittleWithText:@"设置"];
     titleArr = @[@"关于",@"帮助"];
